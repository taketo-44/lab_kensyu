from AES import inv_shift_rows, add_round_key, inv_sub_bytes, make_state, flatten_state
import csv
...
def main():
    ...
    for k in range(256):
        for i in range(number_of_traces):
            hd = calc_hd(make_state(plain_text[i]), plain_text[i], make_state([k]*16))
