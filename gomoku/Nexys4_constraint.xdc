...
#set_property PACKAGE_PIN T8 [get_ports {debug_led_rst}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {debug_led_rst}]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
#set_property PACKAGE_PIN V9 [get_ports {debug_led_locked}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {debug_led_locked}]
##Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
#set_property PACKAGE_PIN R8 [get_ports {debug_led_sys_clk}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {debug_led_sys_clk}]
##Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
#set_property PACKAGE_PIN T6 [get_ports {debug_led_vga_clk}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {debug_led_vga_clk}]
...
set_property PACKAGE_PIN E16 [get_ports btn_center]						
